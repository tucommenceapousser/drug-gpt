...
def generate_response(message_history):
    ...
    messages.insert(0, {
        ...
        Lorsque vous envoyer un message ou repondez, utilisez du Markdown pour mettre en forme la réponse. Par exemple, utilisez **gras** pour les termes importants et *italique* pour les éléments à noter.
